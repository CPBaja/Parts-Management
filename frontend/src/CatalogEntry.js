...
function OrderingPrioritySelect(props) {
  ...
  return (
        <select class="catalog-entry__dropdown--colored" name="ordering_priority">
          <option selected disabled hidden>{props.orderingPriority}</option>
...
function SubassemblySelect(props) {
  ...
  return (
    <select class="catalog-entry__dropdown" name="subassembly">
      <option selected disabled hidden>{props.part.subassembly}</option>
      {subassembliesList}
    </select>
  );
}
    ...
    <form>
      <fieldset>
        ...
        <div class="catalog-entry__quantities">
          ...
          <label>
            Go/NoGo
            <input class="catalog-entry__number" type="number" 
          ...
          <label>
            Available
            <input class="catalog-entry__number catalog-entry__number--available" type="number" 
